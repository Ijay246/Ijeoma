...
"""Save the result of the function in a list named employees. It will contain all the information of 500 workers.
The employees variable will store a list of dictionaries"""
employees = [generate_data() for i in range(500)]
